...
# Lab 03 
# Lab Section: 15
# Sources, people worked with, help given to: "Connor", "Jared", "Caleb", "Jay", "Jed" 
#       gave me their names for the practice list; I looked at my notes from class for sorting;
#       I looked at W3 schools for the syntax for inserting because I replaced the list item
#       the first time: https://www.w3schools.com/python/python_lists_change.asp. I also had 
#       a hard time with the syntax for .upper(), but I played with it until it worked.
...
new_states = ["Washington", "Oregon", "California"]
